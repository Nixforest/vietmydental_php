...
<div class="form">
    ...
    $form = $this->beginWidget('CActiveForm', array(
        'id' => 'product-store-card-details-form',
    ...
    <div class="row">
        <?php echo $form->labelEx($model, 'store_card_id'); ?>
        <?php echo $form->dropDownList($model, 'store_card_id', ProductStoreCards::loadItems()); ?>
        <?php echo $form->error($model, 'store_card_id'); ?>
    </div>
    ...
    <div class="row" style="<?php echo (($model->isNewRecord) ? "display: none;" : ""); ?>">
        ...
        <?php echo $form->dropDownList($model, 'status', ProductStoreCardDetails::getArrayStatus()); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#ProductStoreCardDetails_qty').autoNumeric('init', {lZero:"deny", aPad: false} ); 
    });
</script>
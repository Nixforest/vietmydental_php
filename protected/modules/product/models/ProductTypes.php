 ...
 *
 * The followings are the available columns in table 'product_types':
 ...
 * @property ProductTypes               $rParent                        Parent type
 * @property ProductTypes[]             $rChildren                      Children type
 * @property Products[]                 $rProducts                      List products
 */
class ProductTypes extends BaseTypeRecords {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, name, code, description, parent_id, status, created_date, created_by', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        $parentRelation['rParent']  = array(
            self::BELONGS_TO, 'ProductTypes', 'parent_id',
            'on'    => 'status !=' . self::STATUS_INACTIVE,
        );
        $parentRelation['rChildren'] = array(
            self::HAS_MANY, 'ProductTypes', 'parent_id',
            'on'    => 'status !=' . self::STATUS_INACTIVE,
        );
        $parentRelation['rProducts'] = array(
            self::HAS_MANY, 'Products', 'type_id',
            'on'    => 'status !=' . self::STATUS_INACTIVE,
        );

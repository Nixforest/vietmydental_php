...
<div class="form">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php
            // echo $form->dateField($customer, 'date_of_birth');
            if (!isset($customer->date_of_birth)) {
                $date = DomainConst::DATE_FORMAT_3_NULL;
            } else {
                $date = CommonProcess::convertDateTime($customer->date_of_birth, DomainConst::DATE_FORMAT_4, DomainConst::DATE_FORMAT_3);
                if (empty($date)) {
                    $date = DomainConst::DATE_FORMAT_3_NULL;
                }
            }
...
//            ));
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <?php
            echo $form->textField($medicalRecord, 'record_number',
                    array(
                        'size'          => 60,
                        'maxlength'     => 255,
...
<div class="row buttons">
    <?php
    echo CHtml::submitButton($customer->isNewRecord ? DomainConst::CONTENT00017 : 'Save', array(
        'name' => 'submit',
    ));
    ?>
</div>

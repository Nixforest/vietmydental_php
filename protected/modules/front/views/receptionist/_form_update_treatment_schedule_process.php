...
<!--    <div class="row">
        ...
        $url = Yii::app()->createAbsoluteUrl('admin/ajax/searchUser', array('role' => Roles::getRoleByName('ROLE_DOCTOR')->id));
        $aData = ['model' => $model,
            'field_id' => 'doctor_id',
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'doctor_id'); ?>
        <?php echo $form->dropDownList($model,'doctor_id',
                Users::getListUser(
    ...
    <div class="row buttons">
        <?php echo CHtml::submitButton($model->isNewRecord ? DomainConst::CONTENT00377 : 'Save'); ?>
    </div>

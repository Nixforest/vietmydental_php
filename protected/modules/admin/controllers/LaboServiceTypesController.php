...
class LaboServiceTypesController extends AdminController
{
	/**
...
//		));
	 ...
	 * @return LaboServiceTypes the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=LaboServiceTypes::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param LaboServiceTypes $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='labo-service-types-form')
		{

...
//	}
	...
	{
//		$dataProvider=new CActiveDataProvider('ActionsUsers');
...
//		));
	 ...
	 * @return ActionsUsers the loaded model
	 ...
	 * @param ActionsUsers $model the model to be validated
	 */

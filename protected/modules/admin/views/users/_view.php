...
<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('code_account')); ?>:</b>
	<?php echo CHtml::encode($data->code_account); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('last_logged_in')); ?>:</b>
	<?php echo CHtml::encode($data->last_logged_in); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('address_temp')); ?>:</b>
	<?php echo CHtml::encode($data->address_temp); ?>
	<br />

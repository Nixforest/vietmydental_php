...
$('.search-form form').submit(function(){
	$('#medical-records-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
                    'name'=>'id',
                    'htmlOptions' => array('style' => 'text-align:center;'),
                    'value'=> 'CommonProcess::generateID(DomainConst::MEDICAL_RECORD_ID_PREFIX, $data->id)',
                ),
		array(
                    'name'=>'customer_id',
                    'htmlOptions' => array('style' => 'text-align:center;'),
...
//                    'filter'=>Customers::loadItems(),
		...
		'record_number',
		array(
                    'header' => DomainConst::CONTENT00137,
                    'type' => 'html',
                    'htmlOptions' => array('style' => 'text-align:left;'),
                    'value'=> 'isset($data->rJoinPathological) ? $data->generateMedicalHistory() : ""',
                ),
		'created_date',
                array(
                    'name'=>'status',

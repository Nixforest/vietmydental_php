 ...
 *
 * The followings are the available columns in table 'insurance_companies':
 * @property integer $id
 * @property string $name
 * @property string $description
 */
class InsuranceCompanies extends BaseActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InsuranceCompanies the static model class
	 */

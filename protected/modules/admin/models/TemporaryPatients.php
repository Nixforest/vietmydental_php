...
class TemporaryPatients extends BaseActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('receptionist_id, created_by', 'length', 'max' => 10),
            array('content, book_date, created_date', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, name, phone, content, book_date, customer_id, source_id, receptionist_id, status, created_date, created_by', 'safe', 'on' => 'search'),
        );
    }

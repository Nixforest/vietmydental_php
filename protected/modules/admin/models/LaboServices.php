 ...
 * @property string $id             Labo service id
 * @property string $name           Labo service name
 * @property string $description    Labo service description
 * @property double $price          Labo service price
 * @property string $type_id        Labo service type id
 * @property string $producer_id    Labo producer id
 * @property string $time           Time of warranty
 ...
 * @property LaboServiceTypes       $rType          Labo service type
 * @property LaboServiceProducers   $rProducer      Labo services producer
 */
class LaboServices extends BaseActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            ...
            'producer_id'   => DomainConst::CONTENT00415,
